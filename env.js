 ...
 * for example: if the APP_ENV is staging, the bundle id will be ai.rozo.pos.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'ai.rozo.pos'; // ios bundle id
const PACKAGE = 'ai.rozo.pos'; // android package name
const NAME = 'rozoai-pos'; // app name
const EXPO_ACCOUNT_OWNER = 'expo-owner'; // expo account owner
const EAS_PROJECT_ID = ''; // eas project id
const SCHEME = 'rozoai-pos'; // app scheme
