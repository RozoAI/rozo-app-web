        ...
        <ActionsheetContent style={{ paddingBottom: insets.bottom + bottomInset + 8 }}>
          ...
          <VStack className="w-full" space="lg">
                    ...
                    <Input className="rounded-xl" isInvalid={!!errors.amount}>
                      ...
                      <InputField
                        ...
                        onChangeText={(text) => {
                          ...
                          const cleanValue = sanitizedText.replace(new RegExp(`\\${thousandSeparator}`, 'g'), '');
                          onChange(cleanValue);
                        }}
            ...
            <View className="mt-4 flex-col gap-2">
              ...
              <Button size="lg" onPress={handleCancel} isDisabled={isPending} className="w-full rounded-xl" variant="link">
