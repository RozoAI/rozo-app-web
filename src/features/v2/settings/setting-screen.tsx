...
import { POSToggleSetting } from '@/features/settings/pos-toggle-setting';
...
import { WalletAddressCardV2 } from './wallet-address-card';

export default function SettingScreenV2() {
