...
export default function EmptyOrdersState() {
  return (
    <View className="flex-1 items-center justify-center px-8 py-16">
      ...
      <Text className="mb-2 text-center text-xl font-bold text-gray-900 dark:text-white">No Orders Yet</Text>

      <Text className="text-center text-base leading-6 text-gray-600 dark:text-gray-400">
        Your recent orders will appear here once you start making transactions.
      </Text>
    </View>
  );
}
